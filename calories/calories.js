document.getElementById('calorie-form').addEventListener('submit', function(e){
  ...
  //avoiding default auto loading(redirect) or changes!
  e.preventDefault();
});
...
function calculateCalories(e) {
  ...
  if (age.value === '' || weight.value === '' || height.value === '' || 80 <= age.value || age.value < 18) {
    errorMessage('Please make sure the values you entered are correct!', style='color:red')
  ...
  //styling the elements using javaascript for how to be displaying.
